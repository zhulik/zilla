# Zilla::IoK8sApiCoreV1EphemeralContainer
...
| **volume_mounts** | [**Array&lt;IoK8sApiCoreV1VolumeMount&gt;**](IoK8sApiCoreV1VolumeMount.md) | Pod volumes to mount into the container&#39;s filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated. | [optional] |
...
instance = Zilla::IoK8sApiCoreV1EphemeralContainer.new(
  args: null,
  command: null,
  env: null,
  env_from: null,
