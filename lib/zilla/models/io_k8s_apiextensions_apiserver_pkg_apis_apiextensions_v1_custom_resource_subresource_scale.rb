  ...
  class IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceSubresourceScale
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceSubresourceScale` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceSubresourceScale`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.label_selector_path = attributes[:label_selector_path] if attributes.key?(:label_selector_path)

      self.spec_replicas_path = attributes[:spec_replicas_path] if attributes.key?(:spec_replicas_path)

      return unless attributes.key?(:status_replicas_path)
