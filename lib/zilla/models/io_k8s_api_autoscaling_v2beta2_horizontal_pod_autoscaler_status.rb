  ...
  class IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerStatus
    ...
    def self.openapi_types
      {
        ...
        current_metrics: :'Array<IoK8sApiAutoscalingV2beta2MetricStatus>',
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerStatus` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      if attributes.key?(:current_metrics) && (value = attributes[:current_metrics]).is_a?(Array)
        self.current_metrics = value
      end

      self.current_replicas = attributes[:current_replicas] if attributes.key?(:current_replicas)

      self.desired_replicas = attributes[:desired_replicas] if attributes.key?(:desired_replicas)

      self.last_scale_time = attributes[:last_scale_time] if attributes.key?(:last_scale_time)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        current_metrics == other.current_metrics &&
