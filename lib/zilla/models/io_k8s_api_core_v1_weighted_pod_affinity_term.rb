  ...
  class IoK8sApiCoreV1WeightedPodAffinityTerm
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiCoreV1WeightedPodAffinityTerm` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiCoreV1WeightedPodAffinityTerm`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.pod_affinity_term = attributes[:pod_affinity_term] if attributes.key?(:pod_affinity_term)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        pod_affinity_term == other.pod_affinity_term &&
        weight == other.weight
    end
