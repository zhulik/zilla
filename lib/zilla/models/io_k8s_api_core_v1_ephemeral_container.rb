  ...
  class IoK8sApiCoreV1EphemeralContainer
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiCoreV1EphemeralContainer` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiCoreV1EphemeralContainer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.target_container_name = attributes[:target_container_name] if attributes.key?(:target_container_name)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        target_container_name == other.target_container_name &&
    ...
    def hash
      [args, command, env, env_from, image, image_pull_policy, lifecycle, liveness_probe, name, ports, readiness_probe,
       resources, security_context, startup_probe, stdin, stdin_once, target_container_name, termination_message_path, termination_message_policy, tty, volume_devices, volume_mounts, working_dir].hash
    end
