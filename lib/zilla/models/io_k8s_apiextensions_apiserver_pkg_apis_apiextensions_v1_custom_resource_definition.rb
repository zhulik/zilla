...
module Zilla
  ...
  class IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
    ...
    attr_accessor :metadata, :spec, :status
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.spec = attributes[:spec] if attributes.key?(:spec)
    ...
    def list_invalid_properties
      invalid_properties = []
      invalid_properties.push('invalid value for "spec", spec cannot be nil.') if @spec.nil?
