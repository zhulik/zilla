  ...
  class IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end

        h[k.to_sym] = v
      end

      self.ca_bundle = attributes[:ca_bundle] if attributes.key?(:ca_bundle)

      self.group = attributes[:group] if attributes.key?(:group)

      self.group_priority_minimum = attributes[:group_priority_minimum] if attributes.key?(:group_priority_minimum)
      ...
      return unless attributes.key?(:version_priority)
    ...
    def valid?
      if !@ca_bundle.nil? && @ca_bundle !~ Regexp.new(%r{^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$})
        return false
      end
    ...
    def ca_bundle=(ca_bundle)
      ...
      if !ca_bundle.nil? && ca_bundle !~ pattern
        raise ArgumentError,
              "invalid value for \"ca_bundle\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        group == other.group &&
        group_priority_minimum == other.group_priority_minimum &&
        insecure_skip_tls_verify == other.insecure_skip_tls_verify &&
        service == other.service &&
        version == other.version &&
        version_priority == other.version_priority
    end
