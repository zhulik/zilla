  ...
  class IoK8sApiAdmissionregistrationV1MutatingWebhook
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        raise ArgumentError,
              'The input argument (attributes) must be a hash in `Zilla::IoK8sApiAdmissionregistrationV1MutatingWebhook` initialize method'
      end
      ...
      attributes = attributes.each_with_object({}) do |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          raise ArgumentError,
                "`#{k}` is not a valid attribute in `Zilla::IoK8sApiAdmissionregistrationV1MutatingWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
      ...
      self.reinvocation_policy = attributes[:reinvocation_policy] if attributes.key?(:reinvocation_policy)
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        reinvocation_policy == other.reinvocation_policy &&
        rules == other.rules &&
    ...
    def hash
      [admission_review_versions, client_config, failure_policy, match_policy, name, namespace_selector,
       object_selector, reinvocation_policy, rules, side_effects, timeout_seconds].hash
    end
