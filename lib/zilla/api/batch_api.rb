...
module Zilla
  class BatchApi
    ...
    def get_batch_api_group(opts = {})
      data, _status_code, _headers = get_batch_api_group_with_http_info(opts)
      data
    end
    ...
    def get_batch_api_group_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: BatchApi.get_batch_api_group ...' if @api_client.config.debugging
      # resource path
      ...
      new_options = opts.merge(
        operation: :'BatchApi.get_batch_api_group',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BatchApi#get_batch_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
