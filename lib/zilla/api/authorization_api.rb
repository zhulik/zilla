...
module Zilla
  class AuthorizationApi
    ...
    def get_authorization_api_group(opts = {})
      data, _status_code, _headers = get_authorization_api_group_with_http_info(opts)
      data
    end
    ...
    def get_authorization_api_group_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthorizationApi.get_authorization_api_group ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        operation: :'AuthorizationApi.get_authorization_api_group',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthorizationApi#get_authorization_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
