...
module Zilla
  class AppsApi
    ...
    def get_apps_api_group(opts = {})
      data, _status_code, _headers = get_apps_api_group_with_http_info(opts)
      data
    end
    ...
    def get_apps_api_group_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: AppsApi.get_apps_api_group ...' if @api_client.config.debugging
      # resource path
      ...
      new_options = opts.merge(
        operation: :'AppsApi.get_apps_api_group',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AppsApi#get_apps_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
