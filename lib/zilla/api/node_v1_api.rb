...
module Zilla
  class NodeV1Api
    ...
    # @param body [IoK8sApiNodeV1RuntimeClass]
    ...
    def create_node_v1_runtime_class(body, opts = {})
      data, _status_code, _headers = create_node_v1_runtime_class_with_http_info(body, opts)
      data
    end
    ...
    # @option opts [String] :field_manager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the &#x60;ServerSideFieldValidation&#x60; feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the &#x60;ServerSideFieldValidation&#x60; feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the &#x60;ServerSideFieldValidation&#x60; feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(IoK8sApiNodeV1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1RuntimeClass data, response status code and response headers
    def create_node_v1_runtime_class_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.create_node_v1_runtime_class ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling NodeV1Api.create_node_v1_runtime_class"
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoK8sApiNodeV1RuntimeClass'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        operation: :'NodeV1Api.create_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#create_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_node_v1_collection_runtime_class(opts = {})
      data, _status_code, _headers = delete_node_v1_collection_runtime_class_with_http_info(opts)
      data
    end
    ...
    def delete_node_v1_collection_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.delete_node_v1_collection_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1/runtimeclasses'
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.delete_node_v1_collection_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#delete_node_v1_collection_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body
    # @return [IoK8sApimachineryPkgApisMetaV1Status]
    def delete_node_v1_runtime_class(name, opts = {})
      data, _status_code, _headers = delete_node_v1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [IoK8sApimachineryPkgApisMetaV1DeleteOptions] :body
    # @return [Array<(IoK8sApimachineryPkgApisMetaV1Status, Integer, Hash)>] IoK8sApimachineryPkgApisMetaV1Status data, response status code and response headers
    def delete_node_v1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.delete_node_v1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling NodeV1Api.delete_node_v1_runtime_class"
      end
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.delete_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#delete_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    def get_node_v1_api_resources(opts = {})
      data, _status_code, _headers = get_node_v1_api_resources_with_http_info(opts)
      data
    end
    ...
    def get_node_v1_api_resources_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.get_node_v1_api_resources ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.get_node_v1_api_resources',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#get_node_v1_api_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    def list_node_v1_runtime_class(opts = {})
      data, _status_code, _headers = list_node_v1_runtime_class_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :timeout_seconds Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(IoK8sApiNodeV1RuntimeClassList, Integer, Hash)>] IoK8sApiNodeV1RuntimeClassList data, response status code and response headers
    def list_node_v1_runtime_class_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.list_node_v1_runtime_class ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1/runtimeclasses'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IoK8sApiNodeV1RuntimeClassList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['BearerToken']

      new_options = opts.merge(
        operation: :'NodeV1Api.list_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#list_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @return [IoK8sApiNodeV1RuntimeClass]
    def patch_node_v1_runtime_class(name, body, opts = {})
      data, _status_code, _headers = patch_node_v1_runtime_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [Boolean] :force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    # @return [Array<(IoK8sApiNodeV1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1RuntimeClass data, response status code and response headers
    def patch_node_v1_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.patch_node_v1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling NodeV1Api.patch_node_v1_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling NodeV1Api.patch_node_v1_runtime_class"
      end
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.patch_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#patch_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @return [IoK8sApiNodeV1RuntimeClass]
    def read_node_v1_runtime_class(name, opts = {})
      data, _status_code, _headers = read_node_v1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    # @option opts [String] :pretty If &#39;true&#39;, then the output is pretty printed.
    # @return [Array<(IoK8sApiNodeV1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1RuntimeClass data, response status code and response headers
    def read_node_v1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.read_node_v1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling NodeV1Api.read_node_v1_runtime_class"
      end
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.read_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#read_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the &#x60;ServerSideFieldValidation&#x60; feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the &#x60;ServerSideFieldValidation&#x60; feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the &#x60;ServerSideFieldValidation&#x60; feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [IoK8sApiNodeV1RuntimeClass]
    def replace_node_v1_runtime_class(name, body, opts = {})
      data, _status_code, _headers = replace_node_v1_runtime_class_with_http_info(name, body, opts)
      data
    end
    ...
    # @option opts [String] :field_validation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields, provided that the &#x60;ServerSideFieldValidation&#x60; feature gate is also enabled. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23 and is the default behavior when the &#x60;ServerSideFieldValidation&#x60; feature gate is disabled. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default when the &#x60;ServerSideFieldValidation&#x60; feature gate is enabled. - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
    # @return [Array<(IoK8sApiNodeV1RuntimeClass, Integer, Hash)>] IoK8sApiNodeV1RuntimeClass data, response status code and response headers
    def replace_node_v1_runtime_class_with_http_info(name, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.replace_node_v1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling NodeV1Api.replace_node_v1_runtime_class"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        raise ArgumentError,
              "Missing the required parameter 'body' when calling NodeV1Api.replace_node_v1_runtime_class"
      end
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.replace_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#replace_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    def watch_node_v1_runtime_class(name, opts = {})
      data, _status_code, _headers = watch_node_v1_runtime_class_with_http_info(name, opts)
      data
    end
    ...
    def watch_node_v1_runtime_class_with_http_info(name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.watch_node_v1_runtime_class ...'
      end
      # verify the required parameter 'name' is set
      if @api_client.config.client_side_validation && name.nil?
        raise ArgumentError,
              "Missing the required parameter 'name' when calling NodeV1Api.watch_node_v1_runtime_class"
      end

      # resource path
      local_var_path = '/apis/node.k8s.io/v1/watch/runtimeclasses/{name}'.sub('{name}', CGI.escape(name.to_s))
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.watch_node_v1_runtime_class',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#watch_node_v1_runtime_class\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [IoK8sApimachineryPkgApisMetaV1WatchEvent]
    def watch_node_v1_runtime_class_list(opts = {})
      data, _status_code, _headers = watch_node_v1_runtime_class_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Boolean] :watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    # @return [Array<(IoK8sApimachineryPkgApisMetaV1WatchEvent, Integer, Hash)>] IoK8sApimachineryPkgApisMetaV1WatchEvent data, response status code and response headers
    def watch_node_v1_runtime_class_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: NodeV1Api.watch_node_v1_runtime_class_list ...'
      end
      # resource path
      local_var_path = '/apis/node.k8s.io/v1/watch/runtimeclasses'
      ...
      new_options = opts.merge(
        operation: :'NodeV1Api.watch_node_v1_runtime_class_list',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeV1Api#watch_node_v1_runtime_class_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      [data, status_code, headers]
    end
  end
