...
module Zilla
  class PolicyApi
    ...
    def get_policy_api_group(opts = {})
      data, _status_code, _headers = get_policy_api_group_with_http_info(opts)
      data
    end
    ...
    def get_policy_api_group_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: PolicyApi.get_policy_api_group ...' if @api_client.config.debugging
      # resource path
      ...
      new_options = opts.merge(
        operation: :'PolicyApi.get_policy_api_group',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyApi#get_policy_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
