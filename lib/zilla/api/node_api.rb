...
module Zilla
  class NodeApi
    ...
    def get_node_api_group(opts = {})
      data, _status_code, _headers = get_node_api_group_with_http_info(opts)
      data
    end
    ...
    def get_node_api_group_with_http_info(opts = {})
      @api_client.config.logger.debug 'Calling API: NodeApi.get_node_api_group ...' if @api_client.config.debugging
      # resource path
      ...
      new_options = opts.merge(
        operation: :'NodeApi.get_node_api_group',
        header_params:,
        query_params:,
        form_params:,
        body: post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NodeApi#get_node_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
