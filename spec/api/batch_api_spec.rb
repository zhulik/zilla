...
describe 'BatchApi' do
  ...
  describe 'test an instance of BatchApi' do
    it 'should create an instance of BatchApi' do
      expect(@api_instance).to be_instance_of(Zilla::BatchApi)
    end
  end

  # unit tests for get_batch_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_batch_api_group test' do
    it 'should work' do
