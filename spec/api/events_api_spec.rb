...
# Unit tests for Zilla::EventsApi
...
describe 'EventsApi' do
  ...
  describe 'test an instance of EventsApi' do
    it 'should create an instance of EventsApi' do
      expect(@api_instance).to be_instance_of(Zilla::EventsApi)
    end
  end

  # unit tests for get_events_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_events_api_group test' do
    it 'should work' do
