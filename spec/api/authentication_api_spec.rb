...
# Unit tests for Zilla::AuthenticationApi
...
describe 'AuthenticationApi' do
  ...
  describe 'test an instance of AuthenticationApi' do
    it 'should create an instance of AuthenticationApi' do
      expect(@api_instance).to be_instance_of(Zilla::AuthenticationApi)
    end
  end

  # unit tests for get_authentication_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_authentication_api_group test' do
    it 'should work' do
