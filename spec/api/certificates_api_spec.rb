...
# Unit tests for Zilla::CertificatesApi
...
describe 'CertificatesApi' do
  ...
  describe 'test an instance of CertificatesApi' do
    it 'should create an instance of CertificatesApi' do
      expect(@api_instance).to be_instance_of(Zilla::CertificatesApi)
    end
  end

  # unit tests for get_certificates_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_certificates_api_group test' do
    it 'should work' do
