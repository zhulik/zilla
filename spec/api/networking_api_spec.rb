...
# Unit tests for Zilla::NetworkingApi
...
describe 'NetworkingApi' do
  ...
  describe 'test an instance of NetworkingApi' do
    it 'should create an instance of NetworkingApi' do
      expect(@api_instance).to be_instance_of(Zilla::NetworkingApi)
    end
  end

  # unit tests for get_networking_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_networking_api_group test' do
    it 'should work' do
