...
# Unit tests for Zilla::StorageApi
...
describe 'StorageApi' do
  ...
  describe 'test an instance of StorageApi' do
    it 'should create an instance of StorageApi' do
      expect(@api_instance).to be_instance_of(Zilla::StorageApi)
    end
  end

  # unit tests for get_storage_api_group
  # get information of a group
  # @param [Hash] opts the optional parameters
  # @return [IoK8sApimachineryPkgApisMetaV1APIGroup]
  describe 'get_storage_api_group test' do
    it 'should work' do
